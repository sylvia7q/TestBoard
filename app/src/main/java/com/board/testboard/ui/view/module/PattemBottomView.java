 ...
 * 模板底部模块
 */
public class PattemBottomView extends LinearLayout {
    ...
    public PattemBottomView(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public PattemBottomView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }
