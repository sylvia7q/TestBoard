...
import com.board.testboard.adapter.ViewWorkshopTableAdapter;
 ...
 * 车间看板制令单产出信息表格模块
 */
public class WorkshopTableView extends LinearLayout {
    ...
    public WorkshopTableView(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public WorkshopTableView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }
     ...
     */
    private void init() {
        View view = LayoutInflater.from(context).inflate(R.layout.view_workshop_table, this);
