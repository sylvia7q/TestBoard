...
/**
 * 备注：修改了制令单产出方法【TCL还未启用新的制令单产出相关表】
 * 线看板模板[现在在用的客户：TCL]
 * 包含制令单信息模块，制令单产出信息模块，人员岗位信息模块，设备运转率模块，时段产量模块，欠料预警模块，班次信息模块，同步当前时间模块，各个模块信息
 * 需要选择线别，设置线别展示时长
 */
public class SMTLineBoardV5Activity extends BasePattemActivity {
    ...
    private final String TAG = SMTLineBoardV5Activity.class.getSimpleName();
    ...
    private long nSMTLineOperatingRateLastRefreshTime = 0l;//设备运转率模块刷新时间间隔
    private long nSMTLineOperatingRateHeartbeatInteval = 0l;//设备运转率模块刷新时间间隔
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = SMTLineBoardV5Activity.this;
    ...
    private void initMenuTitleView() {
        ...
        menuTitle.setBtnRightOnclickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                openActivity(context, SettingSMTLineBoardActivity.class,"Activity","SMTLineBoardV5Activity");
            }
        });
    }
...
//        disMessage(disMessage);//一开始初始化显示，但是没有数据会显得有些突兀，所以在获取数据之后再显示
    ...
    public void getPattem(String sKanBanMCNo) {
        ...
        getKanBanUserPattem(context, sKanBanMCNo, new OnResultListener() {
            ...
            public void onSuccess(String sDateNow) {
                ...
                mc_pattem = dbUtil.getMcPattemByCode(template_code[7]);//更新展示模板
                user_pattem = dbUtil.getUserPattemByCode(template_code[7]);//更新用户模板
                if (user_pattem != null) {
                    ...
                    SharedPreferencesUtil.saveValue(context, "nSMTLineMcPattemLastRefreshTimeV5", DateUtils.dateToLong(refreshTime));
            ...
            public void onReceived(String message) {
                if (isStopReceiver) {
                    ...
                    if (isAutoPattem.equals("Y")) {
                        nSMTLineMcPattemLastRefreshTime = SharedPreferencesUtil.getValue(context, "nSMTLineMcPattemLastRefreshTimeV5", 0l);
                        ...
                        if(timeRefresh) {
                            ...
                            if (tempPattem != null) {
                                ...
                                if (!TextUtils.isEmpty(className)) {
                                    if (!className.equals("com.topcee.kanban.ui.activity.pattem.SMTLineBoardV5Activity")) {
                                        openActivity(context, className, "isAutoPattem", isAutoPattem);
                                        SMTLineBoardV5Activity.this.finish();
                                    } else {
                                        initData(dbUtil);
                                    }
                                    return;
    ...
    private void initData(DBUtil dbUtil) {
        nSMTLineWoLastRefreshTime = SharedPreferencesUtil.getValue(context, "nSMTLineWoLastRefreshTimeV5", 0l);
        nSMTLineWoProductionLastRefreshTime = SharedPreferencesUtil.getValue(context, "nSMTLineWoProductionLastRefreshTimeV5", 0l);
        nSMTLineEmployeeLastRefreshTime = SharedPreferencesUtil.getValue(context, "nSMTLineEmployeeLastRefreshTimeV5", 0l);
        nSMTLinePeriodLastRefreshTime = SharedPreferencesUtil.getValue(context, "nSMTLinePeriodLastRefreshTimeV5", 0l);
        nSMTLineWarnLastRefreshTime = SharedPreferencesUtil.getValue(context, "nSMTLineWarnLastRefreshTimeV5", 0l);
        nSMTLineMessageLastRefreshTime = SharedPreferencesUtil.getValue(context, "nSMTLineMessageLastRefreshTimeV5", 0l);
        nSMTLineShiftLastRefreshTime = SharedPreferencesUtil.getValue(context, "nSMTLineShiftLastRefreshTimeV5", 0l);
        nSMTLineOperatingRateLastRefreshTime = SharedPreferencesUtil.getValue(context, "nSMTLineOperatingRateLastRefreshTimeV5", 0l);

        if (lineIndex >= moreLines.size()) {
            lineIndex = 0;
        }
        sLineNo = moreLines.get(lineIndex).getLINE_NO();
        lastLineRefreshTime = SharedPreferencesUtil.getValue(context, "lastLineRefreshTimeV5", 0l);
        ...
        if (lineRefresh) {
            ...
            SharedPreferencesUtil.saveValue(context, "lastLineRefreshTimeV5", lastLineRefreshTime);
        } else {
        ...
        getTimsGetWoInfo(sInterfaceType, sLineNoIn, sWorkShopNo, sSMTLineLanguage, new OnGetDataListener() {
            ...
            public void onGetData(String result) {
                ...
                try {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLineWoLastRefreshTimeV5",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
...
//                        ToastUtil.showShortToast(context,String.format(getString(R.string.parse_error),methodname));
    ...
    public void getWoProductionInfo(String sInterfaceType,String sLineNoIn) {
        getWoProductionInfoForWo(sInterfaceType, sLineNoIn, sSMTLineLanguage, new OnGetDataListener() {
            @Override
            public void onGetData(String result) {
                if (TextUtils.isEmpty(result)) {
                    if(toast!=null){
                ...
                try {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLineWoProductionLastRefreshTimeV5",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
        ...
        if(MyApplication.sMesUser.equals("SZYDM")||MyApplication.sMesUser.equals("TCL")){
            getDutyPersonInfo(sLineNo, sSMTLineLanguage, new OnGetSoapObjectListener() {
                ...
                public void onGetData(SoapObject object) {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLineEmployeeLastRefreshTimeV5",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
                        refreshTime = sDateNow;
                        switch (time){
                            case "refreshTime":
        ...
        getWarnInfo(sWo, sSMTLineLanguage, new OnGetDataListener() {
            ...
            public void onGetData(String result) {
                ...
                try {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLineWarnLastRefreshTimeV5",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
                        refreshTime = sDateNow;
                        switch (time){
                            case "refreshTime":
        ...
        getTimsGetPeriodOutputInfo(sInterfaceType, sLineNo, sSMTLineLanguage, new OnGetDataListener() {
            ...
            public void onGetData(String result) {
                ...
                try {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLinePeriodLastRefreshTimeV5",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
                        refreshTime = sDateNow;
                        switch (time){
                            case "refreshTime":
        ...
        getKanBanMsg(code, json, sSMTLineLanguage, new OnGetDataListener() {
            ...
            public void onGetData(String result) {
                ...
                try {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLineMessageLastRefreshTimeV5",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
                        refreshTime = sDateNow;
                        switch (time){
                            case "refreshTime":
        ...
        getShiftInfo(sInterfaceType, sLineNo, sSMTLineLanguage, new OnGetDataListener() {
            ...
            public void onGetData(String result) {
                ...
                try {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLineShiftLastRefreshTimeV5",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
                        refreshTime = sDateNow;
                        switch (time){
                            case "refreshTime":
        ...
        getOperatingRate(sLineNo, sSMTLineLanguage, new OnGetDataListener() {
            ...
            public void onGetData(String result) {
                ...
                try {
                    ...
                    SharedPreferencesUtil.saveValue(context, "nSMTLineOperatingRateLastRefreshTimeV5", DateUtils.dateToLong(sDateNow));
                    if (!TextUtils.isEmpty(time)) {
                        String cTime = sDateNow;
                        switch (time) {
                            case "refreshTime":
