...
/**
 * Created by longq on 18/12/20.
 */
public class MarqueeFeedAlarmView extends SurfaceView implements SurfaceHolder.Callback{
    ...
    public MarqueeFeedAlarmView(Context context) {
        this(context,null);
    }

    public MarqueeFeedAlarmView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MarqueeFeedAlarmView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                        canvas.drawText(margueeString,currentX, baseY,mTextPaint);
                        canvas.drawText(margueeString,currentX, centeYLine+dip2px(getContext(),textHeight)/2 + 5,mTextPaint);
