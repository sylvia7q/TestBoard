 ...
 * [现在在用的客户：DOOV]
 * 线看板模板[朵唯客制版]
 * 区别其他看板的区别在于DOOV使用粉色作为背景，标题栏部分用了DOOV公司专用LOGO，并且滚动条内容显示在标题栏中间
 * 包含制令单信息模块，制令单产出信息模块，人员岗位信息模块，时段产量模块，时段良率模块(品质信息)，班次信息模块，同步当前时间模块，各个模块信息，
 */
public class SMTLineBoardV4Activity extends BasePattemV3WorkshopV4LineActivity{
    ...
    private  final String TAG = SMTLineBoardV4Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = SMTLineBoardV4Activity.this;

    }

    @Override
    protected int getModuleLayoutId() {
        return R.layout.activity_smt_line_board_v4;
    }
    ...
    private void initMenuTitleView() {
        ...
        menuTitle.setBtnRightOnclickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                openActivity(context, SettingSMTLineBoardActivity.class,"Activity","SMTLineBoardV4Activity");
            }
        });
    }
...
//            viewWo.setCurShiftTotalQtyTitle("Current shift total output");
    ...
    private void initColor() {
        ...
        nSMTLineWholeBgColor = SharedPreferencesUtil.getValue(getBaseContext(), "nSMTLineV4WholeBgColor", MyApplication.nDefaultSMTLineV4WholeBgColor);//V4看板的颜色默认为粉红色
...
//        }
    ...
    public void getPattem(String sKanBanMCNo) {
        ...
        getKanBanUserPattem(context, sKanBanMCNo, new OnResultListener() {
            ...
            public void onSuccess(String sDateNow) {
                ...
                mc_pattem = dbUtil.getMcPattemByCode(template_code[5]);//更新展示模板
                user_pattem = dbUtil.getUserPattemByCode(template_code[5]);//更新展示模板
                if(user_pattem!=null){
                    ...
                    if(!TextUtils.isEmpty(time)){
                        ...
                        LogUtil.e(TAG,"nSMTLineMcPattemLastRefreshTime = " + refreshTime + ", DateUtils.dateToLong(refreshTime) = " + DateUtils.dateToLong(refreshTime));
                        SharedPreferencesUtil.saveValue(context,"nSMTLineMcPattemLastRefreshTimeV4",DateUtils.dateToLong(refreshTime));
                        switch (time){
                            case "refreshTime":
                                Message message = new Message();
            ...
            public void onReceived(String message) {
                if(isStopReceiver){
                    ...
                    if (isAutoPattem.equals("Y")) {
                        nSMTLineMcPattemLastRefreshTime = SharedPreferencesUtil.getValue(context,"nSMTLineMcPattemLastRefreshTimeV4",0l);
                        ...
                        if(timeRefresh) {
                            ...
                            if(tempPattem!=null){
                                ...
                                if(!TextUtils.isEmpty(className)){
                                    if(!className.equals("com.topcee.kanban.ui.activity.pattem.SMTLineBoardV4Activity")){
                                        openActivity(context,className,"isAutoPattem",isAutoPattem);
                                        SMTLineBoardV4Activity.this.finish();
                                    }else {
                                        initData(dbUtil);
                                    }
                                    return;
    ...
    private void initData(DBUtil dbUtil) {
        nSMTLineWoLastRefreshTime = SharedPreferencesUtil.getValue(context,"nSMTLineWoLastRefreshTimeV4",0l);
        nSMTLineWoProductionLastRefreshTime = SharedPreferencesUtil.getValue(context,"nSMTLineWoProductionLastRefreshTimeV4",0l);
        nSMTLineEmployeeLastRefreshTime = SharedPreferencesUtil.getValue(context,"nSMTLineEmployeeLastRefreshTimeV4",0l);
        nSMTLinePeriodLastRefreshTime = SharedPreferencesUtil.getValue(context,"nSMTLinePeriodLastRefreshTimeV4",0l);
        nSMTLineWarnLastRefreshTime = SharedPreferencesUtil.getValue(context,"nSMTLineWarnLastRefreshTimeV4",0l);
        nSMTLineMessageLastRefreshTime = SharedPreferencesUtil.getValue(context,"nSMTLineMessageLastRefreshTimeV4",0l);
        nSMTLineShiftLastRefreshTime = SharedPreferencesUtil.getValue(context,"nSMTLineShiftLastRefreshTimeV4",0l);
        
        if(lineIndex >= moreLines.size()){
            lineIndex = 0;
        }
        sLineNo = moreLines.get(lineIndex).getLINE_NO();
        lastLineRefreshTime = SharedPreferencesUtil.getValue(context,"lastLineRefreshTimeV4",0l);
        ...
        if (lineRefresh) {
            ...
            SharedPreferencesUtil.saveValue(context,"lastLineRefreshTimeV4",lastLineRefreshTime);
        }else {
        ...
        getTimsGetWoInfo(sInterfaceType, sLineNoIn, sWorkShopNo, sSMTLineLanguage, new OnGetDataListener() {
            ...
            public void onGetData(String result) {
                ...
                try {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLineWoLastRefreshTimeV4",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
        ...
        getWoProductionInfo(sInterfaceType, sLineNoIn, sSMTLineLanguage, new OnGetDataListener() {
            ...
            public void onGetData(String result) {
                ...
                try {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLineWoProductionLastRefreshTimeV4",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
                        refreshTime = sDateNow;
                        switch (time){
                            case "refreshTime":
        ...
        if(MyApplication.sMesUser.equals("SZYDM")||MyApplication.sMesUser.equals("TCL")){
            getDutyPersonInfo(sLineNo, sSMTLineLanguage, new OnGetSoapObjectListener() {
                ...
                public void onGetData(SoapObject object) {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLineEmployeeLastRefreshTimeV4",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
                        refreshTime = sDateNow;
                        switch (time){
                            case "refreshTime":
        ...
        getWarnInfo(sWo, sSMTLineLanguage, new OnGetDataListener() {
            ...
            public void onGetData(String result) {
                ...
                try {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLineWarnLastRefreshTimeV4",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
                        refreshTime = sDateNow;
                        switch (time){
                            case "refreshTime":
        ...
        getTimsGetPeriodOutputInfo(sInterfaceType, sLineNo, sSMTLineLanguage, new OnGetDataListener() {
            ...
            public void onGetData(String result) {
                ...
                try {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLinePeriodLastRefreshTimeV4",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
                        refreshTime = sDateNow;
                        switch (time){
                            case "refreshTime":
        ...
        getKanBanMsg(code, json, sSMTLineLanguage, new OnGetDataListener() {
            ...
            public void onGetData(String result) {
                ...
                try {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLineMessageLastRefreshTimeV4",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
                        refreshTime = sDateNow;
                        switch (time){
                            case "refreshTime":
...
//                    ToastUtil.showLongToast(context, sMsg);
                    ...
                    if(messageList!=null && messageList.size()>=1){
                        ...
                        LogUtil.e(TAG,"newScrollText = " + newScrollText + ",messageFlag = " + messageFlag);
        ...
        getShiftInfo(sInterfaceType, sLineNo, sSMTLineLanguage, new OnGetDataListener() {
            ...
            public void onGetData(String result) {
                ...
                try {
                    ...
                    SharedPreferencesUtil.saveValue(context,"nSMTLineShiftLastRefreshTimeV4",DateUtils.dateToLong(sDateNow));
                    if(!TextUtils.isEmpty(time)){
                        refreshTime = sDateNow;
                        switch (time){
                            case "refreshTime":
