...
public class SMTWorkshopLineAdapter extends ArrayAdapter {

    private Context context;
    private List<SMT_WORKSHOP_LINE_SETTING> list;
    private int mResourceId;

    public SMTWorkshopLineAdapter(@NonNull Context context, int resource, @NonNull List objects) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        SMT_WORKSHOP_LINE_SETTING moreLine  = list.get(position);
        if(moreLine!=null){
