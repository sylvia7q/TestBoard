...
public class SMTTotalAlarmService extends IntentService {
    // 从其他地方通过Intent传递过来的提醒时间
    private String alarmDateTime;
    private String TAG = SMTTotalAlarmService.class.getSimpleName();

    //必须实现父类的构造方法
    public SMTTotalAlarmService() {
        super("AlarmService");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        AlarmManagerUtil.sendRepeatAlarmBroadcast(this, taskId, AlarmManager.RTC_WAKEUP, alarmDateTimeMillis, nRefreshTimeSet* 1000, SMTTotalAlarmReceiver.class);
